...
#pragma warning disable IDE0059 // Unnecessary assignment of a value
            int objLen = Decode(buf, off, len, out int tc, out int tv, out bool cons, out int valOff, out int valLen);
#pragma warning restore IDE0059 // Unnecessary assignment of a value
            ...
            out int valOff, out int valLen)
        {
            ...
            if (vlen < 0)
            {
                ...
                {
#pragma warning disable IDE0059 // Unnecessary assignment of a value
                    int slen = Decode(buf, off, lim - off, out int tc2, out int tv2, out bool cons2, out int valOff2, out int valLen2);
#pragma warning restore IDE0059 // Unnecessary assignment of a value
                    if (tc2 == 0 && tv2 == 0)
                    {
                        if (cons2 || valLen2 != 0)
        ...
        {
#pragma warning disable IDE0059 // Unnecessary assignment of a value
            return GetBitString(out int bitLength);
#pragma warning restore IDE0059 // Unnecessary assignment of a value
        }
